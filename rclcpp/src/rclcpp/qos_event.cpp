...
bool
QOSEventHandlerBase::add_to_wait_set(rcl_wait_set_t * wait_set, bool add_to_wait_set)
{
  rcl_ret_t ret = rcl_wait_set_add_event(wait_set, &event_handle_, &wait_set_event_index_, add_to_wait_set);
  if (RCL_RET_OK != ret) {
