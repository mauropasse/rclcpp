...
using rclcpp::executors::detail::ExecutorEventType;
using rclcpp::executors::detail::ExecutorEvent;

EventsExecutor::EventsExecutor(
  rclcpp::executors::detail::EventsQueue::UniquePtr events_queue,
...
: rclcpp::Executor(options)
{
  ...
  entities_collector_ = std::make_shared<detail::EventsExecutorEntitiesCollector>(this);
  ...
  executor_notifier_ = std::make_shared<detail::EventsExecutorNotifyWaitable>();
