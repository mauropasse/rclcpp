...
#ifndef RCLCPP__EXECUTORS__DETAIL__SIMPLE_EVENTS_QUEUE_HPP_
#define RCLCPP__EXECUTORS__DETAIL__SIMPLE_EVENTS_QUEUE_HPP_
...
public:
  ...
  RCLCPP_PUBLIC
  void
  enqueue(const rclcpp::executors::detail::ExecutorEvent & event) override
  {
    rclcpp::executors::detail::ExecutorEvent single_event = event;
...
private:
  ...
  std::queue<rclcpp::executors::detail::ExecutorEvent> event_queue_;
...
#endif  // RCLCPP__EXECUTORS__DETAIL__SIMPLE_EVENTS_QUEUE_HPP_
