...
#ifndef RCLCPP__EXECUTORS__DETAIL__EVENTS_QUEUE_HPP_
#define RCLCPP__EXECUTORS__DETAIL__EVENTS_QUEUE_HPP_
...
public:
  ...
  virtual
  void
  enqueue(const rclcpp::executors::detail::ExecutorEvent & event) = 0;
...
#endif  // RCLCPP__EXECUTORS__DETAIL__EVENTS_QUEUE_HPP_
