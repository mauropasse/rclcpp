...
#include "rclcpp/executors/detail/events_executor_entities_collector.hpp"
#include "rclcpp/executors/detail/events_executor_event_types.hpp"
#include "rclcpp/executors/detail/events_executor_notify_waitable.hpp"
#include "rclcpp/executors/detail/events_queue.hpp"
...
{
  friend class detail::EventsExecutorEntitiesCollector;
...
public:
  ...
  explicit EventsExecutor(
    rclcpp::executors::detail::EventsQueue::UniquePtr events_queue = std::make_unique<
      rclcpp::executors::detail::SimpleEventsQueue>(),
...
private:
  ...
  RCLCPP_PUBLIC
  void
  execute_event(const detail::ExecutorEvent & event);

  // Queue where entities can push events
  rclcpp::executors::detail::EventsQueue::UniquePtr events_queue_;

  rclcpp::executors::detail::EventsExecutorEntitiesCollector::SharedPtr entities_collector_;
  rclcpp::executors::detail::EventsExecutorNotifyWaitable::SharedPtr executor_notifier_;
